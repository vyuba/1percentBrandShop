        ...
        <div className="w-7 h-5 flex flex-col justify-evenly">
          ...
          ></span>
            ...
            !menuIsOpen ? "left-[-100%]" : "left-0"
                ...
                >
                <img className="w-[70px] lg:hidden ml-[19px] " src={MainLogo} alt="1percent logo" />
                <div className='flex ml-2 my-3 lg:hidden py-1 px-1 items-center border border-[#E91212]'>
                    ...
                    <input className='placeholder:text-gray-500 outline-none' placeholder='Search' type="text" />
                </div>
                <li className="w-full lg:w-fit py-2 px-5 lg:px-3 xl:px-4 text-black hover:text-red-600 hover:bg-red-100  lg:text-white bg-transparent"><Link to={"/Home"}> shop </Link></li>
                <li className="w-full lg:w-fit py-2 px-5 lg:px-3 xl:px-4 text-black hover:text-red-600 hover:bg-red-100  lg:text-white bg-transparent">
                collection
                </li>
                <li className="w-full lg:w-fit py-2 px-5 lg:px-3 xl:px-4 text-black hover:text-red-600 hover:bg-red-100  lg:text-white bg-transparent">
                shirt
